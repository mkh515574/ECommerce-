...
import 'package:ecommerce/features/widgets/custom_badge.dart';
...
import '../viewModel/cart_states.dart';
          ...
          child: BlocBuilder<CartViewModel,CartStates>(
            builder: (context, state) {
              if(state is GetCartErrorState){
                ...
                return Column(
                  children: [
                    state.getCart.products!.isEmpty ? Expanded(child: Column(mainAxisAlignment:MainAxisAlignment.center,children: [
                      Image.asset(AppAssets.emptyCart),
                      SizedBox(
                        height: 10.h,
                      ),
                      Text("No Item In Cart",style: AppStyles.semi20Primary,)
                    ],)): Expanded(
